        ...
        <div className="relative z-10 w-full flex flex-col items-center flex-grow justify-start space-y-8 py-4 text-center">
          ...
          >
            ...
            <p className="text-[#5C4515] text-xs md:text-sm font-marathi leading-relaxed max-w-md mx-auto">
              (कै. आनंदराव अंबाजी भोकरे यांची नात व श्री. दिपक आनंदराव भोकरे व सौ. सुवर्णा दिपक भोकरे यांची द्वितीय सुकन्या)
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#5C4515] text-xs md:text-sm font-marathi leading-relaxed max-w-md mx-auto">
              (कै. दत्तात्रय भैरू जाधव-पाटील यांचे नातू व श्री. मारुती दत्तात्रय जाधव-पाटील व सौ. लक्ष्मी मारुती जाधव-पाटील , यांचे चिरंजीव)
            </p>
          </motion.div>
